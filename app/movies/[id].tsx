...
const MovieDetails = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      ...
      <TouchableOpacity className='absolute top-16 left-0 mx-5 w-fit bg-accent rounded-full p-3.5 flex flex-row items-center justify-center z-50' onPress={router.back}>
        <Image source={icons.arrow} className='size-8 mr-1 mt-0.5 rotate-180 ' tintColor={"#fff"}/>
